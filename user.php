	...
	<body onload="startTime()">
		<section class="head">
			<div class="container-fluid">
				...
				<!-- <div class="col-xs-2 col-md-2 col-lg-2" >
					<img src="img/mc.gif" style="float:right;" height="125" width="125">
				</div> -->
		...
		<footer class="foot" style="text-align: center; padding-top: 14px;">
            <div class="container"><center><span style="font-size: small;"> &copy; 2024 Mabini College, Inc. | Mabini College, Inc.</span></center></div>
            <!-- blank -->
        </footer>
