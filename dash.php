...
?>
<body style="background-color: #ddddddd1;"> 
<!-- MAIN CONTENT START -->
	...
	<div class="container-fluid">
	  <div class="row">
	    <div class="col-md-6">
	        ...
	        <div class="card-body">
	        	<?php if($banner) { ?>
							<img class="img-responsive" src="assets/img/hd.gif">
						<?php }else{ ?>
				...
				<div class="h2 t-shadow">
					<?php
						if ($msg == "1") {
						    ...
						    # code...
						    ?> <span class="animated flash"> <?php 
						    echo "<span class='text-danger'>Invalid Try Again ".$_SESSION['noname']."<br> Contact Librarian for more details.</span>";
						    ?> </span> <?php
						} elseif ($msg == "4") {
						    # code...
						    ?> <span class="animated flash"> <?php 
							...
							<div class="idle">
							    ...
							    <span class='text-info'>ID NO.</span>
							  </div>
							  <div class="row">
									<div class="col-md-3">
